...
def index(request):
    ...
    #     else:
    #         guest = ManeuGuest.objects.filter(id=order.guest_id).update(id=order.id, status=3)
    #     print(guest)
    #
    ...
    #     else:
    #         report = ManeuReport.objects.filter(id=order.report_id).update(id=order.id, status=3)
    #     print(report)
    #
    #
    ...
    #     else:
    #         guest = ManeuGuest.objects.filter(id=report.guest_id).update(id=report.id, status=2)
    #     print(guest)
    #
    #
