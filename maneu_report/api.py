...
def insert(request):
    ...
    if admin_id:
        ...
        content = {'status': True, 'message': '', 'content':{'index_id': index_id, 'order_id': {}, 'guest_id': guest_id, 'report_id': report_id}}
    else:
...
def detail(request):
    ...
    if admin_id and index_id:
        ...
        content = {'status': True, 'message': '', 'content':{'order_id': {}, 'guest_id': guest_id, 'report_id': report_id}}
    else:
